...
from .serializers import CategorySerializer, PostSerializer, PostsSerializer
...
class StandardResultSetPagination(pagination.PageNumberPagination):
    ...
    def get_paginated_response(self, data):
        return response.Response({
            ...
            'total_pages': self.page.paginator.num_page,
...
class PostList(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if keyword:
            queryset = queryset.filter(Q(title__icontains=keyword) | Q(lead_text__icontains=keyword) | Q(main_text__icontains=keyword))
